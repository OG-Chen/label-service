...
from app.api.labels import labels
...
app = FastAPI(openapi_url="/api/v1/labels/openapi.json", docs_url="/api/v1/labels/docs")
...
app.include_router(labels, prefix='/api/v1/labels', tags=['labels'])